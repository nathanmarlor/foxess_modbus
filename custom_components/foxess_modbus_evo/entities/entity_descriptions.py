...
BMS_CONNECT_STATE_ADDRESS = [
    ...
    ModbusAddressSpec(holding=37002, models=Inv.KH_133 | Inv.EVO_10_H),
...
def _version_entities() -> Iterable[EntityFactory]:
    ...
    yield _master_version(
        address=[
            ...
            ModbusAddressSpec(holding=36001, models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_122 | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        is_hex=True,
    )
    ...
    yield _slave_version(
        address=[
            ...
            ModbusAddressSpec(holding=36002, models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_122 | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        is_hex=True,
    )
    ...
    yield _manager_version(
        address=[
            ...
            ModbusAddressSpec(holding=36003, models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        is_hex=True,
    )
...
def _pv_entities() -> Iterable[EntityFactory]:
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39070], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV1 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv1_current",
        addresses=[
            ModbusAddressesSpec(holding=[39071], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV1 Current",
        scale=0.01,
    )
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39280, 39279], models=Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV1 Power",
    )
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39072], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV2 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv2_current",
        addresses=[
            ModbusAddressesSpec(holding=[39073], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV2 Current",
        scale=0.01,
    )
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39282, 39281], models=Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV2 Power",
    )
    yield _pv_energy_total(
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39074], models=Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV3 Voltage",
    )
    yield _pv_current(
    ...
    yield _pv_current(
        key="pv3_current",
        addresses=[
            ModbusAddressesSpec(holding=[39075], models=Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV3 Current",
        scale=0.01,
    )
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39284, 39283], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="PV3 Power",
    )
    yield _pv_energy_total(
    ...
    yield ModbusLambdaSensorDescription(
        ...
        models=[
            EntitySpec(
                register_types=[RegisterType.INPUT, RegisterType.HOLDING],
                models=Inv.ALL & ~(Inv.KH_SET | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
            ),
        ],
...
def _h1_current_voltage_power_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39123], models=Inv.EVO_10_H),
            ModbusAddressesSpec(
    ...
    # Older models (11010 / 31007) -> A = raw / 10
    yield ModbusSensorDescription(
        key="rcurrent",
        addresses=[
    ...
    # EVO (39126 is I32, gain 1000) -> A = raw / 1000
    yield ModbusSensorDescription(
        key="rcurrent",
        addresses=[
            ModbusAddressesSpec(holding=[39127, 39126], models=Inv.EVO_10_H),
        ],
        name="Inverter Current",
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        ...
        scale=0.001,
        round_to=1,
        validate=[Range(0, 200)],  # you may want to bump this higher for EVO if you ever see clipping
    )
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39135, 39134], models=Inv.EVO_10_H),
        ],
        name="Inverter Power",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39201], models=Inv.EVO_10_H),
            ModbusAddressesSpec(
    ...
    # Older models (11016 / 31011) -> A = raw / 10
    yield ModbusSensorDescription(
        key="eps_rcurrent",
        addresses=[
    ...
    # EVO (39204 is I32, gain 1000) -> A = raw / 1000
    yield ModbusSensorDescription(
        key="eps_rcurrent",
        addresses=[
            ModbusAddressesSpec(holding=[39205, 39204], models=Inv.EVO_10_H),
        ],
        entity_registry_enabled_default=False,
        name="EPS Current",
        device_class=SensorDeviceClass.CURRENT,
        ...
        scale=0.001,
        round_to=1,
        validate=[Range(0, 200)],  # consider increasing for EVO if it ever clips
    )
    yield ModbusSensorDescription(
        key="eps_rpower_Q",
        addresses=[
...
def _inverter_entities() -> Iterable[EntityFactory]:
    ...
    yield _invbatvolt(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39227], models=Inv.EVO_10_H),
        ],
    )
    ...
    yield _invbatcurrent(
        ...
        scale=0.001,
        addresses=[
            ModbusAddressesSpec(holding=[39229, 39228], models=Inv.EVO_10_H),
        ],
    )
    ...
    yield from _invbatpower(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39238, 39237], models=Inv.EVO_10_H),
        ],
    )
    yield from _invbatpower(
        index=1,
        addresses=[
            ModbusAddressesSpec(holding=[39231, 39230], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
    )
    yield from _invbatpower(
        index=2,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39139], models=Inv.EVO_10_H),
        ],
        entity_registry_enabled_default=False,
        name="Grid Frequency",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            # EVO
            ModbusAddressesSpec(holding=[39218], models=Inv.EVO_10_H),
        ],
        entity_registry_enabled_default=False,
        name="EPS Frequency",
        device_class=SensorDeviceClass.FREQUENCY,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39141], models=Inv.EVO_10_H),
        ],
        name="Inverter Temp",
    ...
    yield _solar_energy_total(
        addresses=[
                        ModbusAddressesSpec(input=[39602, 39601], holding=[39602, 39601], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _solar_energy_today(
        addresses=[
                        ModbusAddressesSpec(input=[39604, 39603], holding=[39604, 39603], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _battery_charge_total(
        addresses=[
                        ModbusAddressesSpec(input=[39606, 39605], holding=[39606, 39605], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _battery_charge_today(
        addresses=[
                        ModbusAddressesSpec(input=[39608, 39607], holding=[39608, 39607], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _battery_discharge_total(
        addresses=[
                        ModbusAddressesSpec(input=[39610, 39609], holding=[39610, 39609], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _battery_discharge_today(
        addresses=[
                        ModbusAddressesSpec(input=[39612, 39611], holding=[39612, 39611], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _feed_in_energy_total(
        addresses=[
                        ModbusAddressesSpec(input=[39614, 39613], holding=[39614, 39613], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _feed_in_energy_today(
        addresses=[
                        ModbusAddressesSpec(input=[39616, 39615], holding=[39616, 39615], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _grid_consumption_energy_total(
        addresses=[
                        ModbusAddressesSpec(input=[39618, 39617], holding=[39618, 39617], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _grid_consumption_energy_today(
        addresses=[
                        ModbusAddressesSpec(input=[39620, 39619], holding=[39620, 39619], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _total_yield_total(
        addresses=[
                        ModbusAddressesSpec(input=[39622, 39621], holding=[39622, 39621], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _total_yield_today(
        addresses=[
                        ModbusAddressesSpec(input=[39624, 39623], holding=[39624, 39623], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _input_energy_total(
        addresses=[
                        ModbusAddressesSpec(input=[39626, 39625], holding=[39626, 39625], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _input_energy_today(
        addresses=[
                        ModbusAddressesSpec(input=[39628, 39627], holding=[39628, 39627], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _load_power_total(
        addresses=[
                        ModbusAddressesSpec(input=[39630, 39629], holding=[39630, 39629], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
    ...
    yield _load_energy_today(
        addresses=[
                        ModbusAddressesSpec(input=[39632, 39631], holding=[39632, 39631], models=Inv.H3_SMART | Inv.H3_PRO_SET & ~Inv.H3_PRO_PRE122 | Inv.EVO_10_H),
        ],
        scale=0.01,
    )
...
def _bms_entities() -> Iterable[EntityFactory]:
    ...
    yield from _inner(
        ...
        battery_soc=[
            ...
            ModbusAddressesSpec(holding=[39423], models=Inv.EVO_10_H),
        ],
        battery_soh=[
...
def _configuration_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[46607], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=46607, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="Max Charge Current",
        mode=NumberMode.BOX,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[46608], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=46608, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="Max Discharge Current",
        mode=NumberMode.BOX,
        device_class=NumberDeviceClass.CURRENT,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[46609], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="Min SoC",
        device_class=SensorDeviceClass.BATTERY,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=46609, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="Min SoC",
        mode=NumberMode.BOX,
        native_min_value=10,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[46610], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="Max SoC",
        device_class=SensorDeviceClass.BATTERY,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=46610, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="Max SoC",
        mode=NumberMode.BOX,
        native_min_value=10,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[46611], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=46611, models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO_10_H),
        ],
        name="Min SoC (On Grid)",
        mode=NumberMode.BOX,
        native_min_value=10,
