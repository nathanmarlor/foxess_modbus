...
def _pv_entities() -> Iterable[EntityFactory]:
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(
                holding=[39070], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO | Inv.F_G3
            ),
        ],
        name="PV1 Voltage",
    )
    ...
    yield _pv_current(
        ...
        addresses=[
            ModbusAddressesSpec(
                holding=[39071], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO | Inv.F_G3
            ),
        ],
        name="PV1 Current",
        scale=0.01,
    ...
    yield _pv_voltage(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(
                holding=[39072], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO | Inv.F_G3
            ),
        ],
        name="PV2 Voltage",
    )
    ...
    yield _pv_current(
        ...
        addresses=[
            ModbusAddressesSpec(
                holding=[39073], models=Inv.H1_G2_SET | Inv.KH_133 | Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO | Inv.F_G3
            ),
        ],
        name="PV2 Current",
        scale=0.01,
...
def _inverter_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39139], models=Inv.H3_PRO_122 | Inv.EVO | Inv.F_G3),
        ],
        entity_registry_enabled_default=False,
        name="Grid Frequency",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39141], models=Inv.H3_PRO_SET | Inv.H3_SMART | Inv.EVO | Inv.F_G3),
        ],
        name="Inverter Temp",
