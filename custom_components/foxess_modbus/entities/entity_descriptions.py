...
def _version_entities() -> Iterable[EntityFactory]:
    ...
    yield _master_version(
        address=[
            ...
            ModbusAddressSpec(holding=36001, models=Inv.H3_PRO | Inv.KH_133),
        ],
        is_hex=False,
    )
    yield _master_version(
    ...
    yield _slave_version(
        address=[
            ...
            ModbusAddressSpec(holding=36002, models=Inv.H3_PRO | Inv.KH_133),
        ],
        is_hex=False,
    )
    yield _slave_version(
...
def _pv_entities() -> Iterable[EntityFactory]:
    ...
    yield _pv_power(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[39284, 39283], models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="PV3 Power",
    )
    yield _pv_energy_total(
        ...
        models=[
            EntitySpec(
                register_types=[RegisterType.INPUT, RegisterType.HOLDING],
                models=Inv.KH_SET | Inv.H3_PRO | Inv.KH_133,
            ),
        ],
    ...
    yield ModbusLambdaSensorDescription(
        ...
        models=[
            EntitySpec(
                register_types=[RegisterType.INPUT, RegisterType.HOLDING],
                models=Inv.KH_PRE119 | Inv.KH_PRE133 | Inv.H3_PRO,
            ),
        ],
    ...
    yield ModbusSensorDescription(
        key="pv_power_now",
        addresses=[
            ModbusAddressesSpec(holding=[39119, 39118], models=Inv.KH_133),
        ],
        name="PV Power",
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
...
def _h1_current_voltage_power_entities() -> Iterable[EntityFactory]:
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31006], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
        ],
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31007], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
        ],
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31010], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
        ],
        entity_registry_enabled_default=False,
        name="EPS Voltage",
        device_class=SensorDeviceClass.VOLTAGE,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31011], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
        ],
        entity_registry_enabled_default=False,
        name="EPS Current",
        device_class=SensorDeviceClass.CURRENT,
...
def _h3_current_voltage_power_entities() -> Iterable[EntityFactory]:
    ...
    yield _inv_power(
        phase=None,
        addresses=[
            ModbusAddressesSpec(holding=[39135, 39134], models=Inv.H3_PRO | Inv.KH_PRE133),
        ],
    ...
    yield _inv_power_reactive(
        phase=None, addresses=[ModbusAddressesSpec(holding=[39137, 39136], models=Inv.H3_PRO | Inv.KH_PRE133)]
    )
    ...
    yield from _grid_ct(
        ...
        scale=0.0001,  # 0.1W
        addresses=[
            ModbusAddressesSpec(holding=[38815, 38814], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    yield from _grid_ct(
        "R",
    ...
    yield _ct2_meter(
        phase=None,
        scale=0.0001,
        addresses=[ModbusAddressesSpec(holding=[38915, 38914], models=Inv.H3_PRO | Inv.KH_133)],
    )
    ...
    yield _load_power(
        phase=None,
        addresses=[
            ModbusAddressesSpec(holding=[39226, 39225], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
...
def _inverter_entities() -> Iterable[EntityFactory]:
    ...
    yield _invbatvolt(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31020], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[39227], models=Inv.KH_133),
        ],
    )
    ...
    yield _invbatcurrent(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31021], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[39229, 39228], models=Inv.KH_133),
        ],
    )
    yield _invbatcurrent(
    ...
    yield from _invbatpower(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31022], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[31036], models=Inv.H3_SET),
            ModbusAddressesSpec(holding=[39238, 39237], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    yield from _invbatpower(
        index=1,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31009], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[31015], models=Inv.H3_SET),
            ModbusAddressesSpec(holding=[38847, 38846], models=Inv.H3_PRO | Inv.KH_133),
        ],
        entity_registry_enabled_default=False,
        name="Grid Frequency",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31013], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[31025], models=Inv.H3_SET),
            ModbusAddressesSpec(holding=[39218], models=Inv.KH_133),
        ],
        entity_registry_enabled_default=False,
        name="EPS Frequency",
        device_class=SensorDeviceClass.FREQUENCY,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31018], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[31032], models=Inv.H3_SET),
            ModbusAddressesSpec(holding=[39141], models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Inverter Temp",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31019], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
    ...
    yield ModbusBatterySensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31025], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
        ],
        entity_registry_enabled_default=False,
    ...
    yield ModbusBatterySensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[31026], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
        ],
        entity_registry_enabled_default=False,
        bms_connect_state_address=BMS_CONNECT_STATE_ADDRESS,
    ...
    yield ModbusInverterStateSensorDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=31027, models=Inv.KH_PRE133),
        ],
        name="Inverter State",
    ...
    yield ModbusG2InverterStateSensorDescription(
        key="inverter_state",
        addresses=[
            ModbusAddressesSpec(holding=[39063, 39065], models=Inv.H1_G2 | Inv.H3_PRO | Inv.KH_133),
        ],
        name="Inverter State",
    )
    yield ModbusSensorDescription(
    ...
    yield _solar_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32001, 32000], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39602, 39601], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _solar_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32002], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39604, 39603], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _battery_charge_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32004, 32003], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39606, 39605], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _battery_charge_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32005], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39608, 39607], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _battery_discharge_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32007, 32006], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39610, 39609], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _battery_discharge_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32008], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39612, 39611], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _feed_in_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32010, 32009], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39614, 39613], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _feed_in_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32011], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39616, 39615], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _grid_consumption_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32013, 32012], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39618, 39617], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _grid_consumption_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32014], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39620, 39619], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _total_yield_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32016, 32015], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39622, 39621], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _total_yield_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32017], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39624, 39623], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _input_energy_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32019, 32018], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39626, 39625], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _input_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32020], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39628, 39627], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _load_power_total(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32022, 32021], models=Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39630, 39629], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
    ...
    yield _load_energy_today(
        addresses=[
            ...
            ModbusAddressesSpec(holding=[32023], models=Inv.H1_G1 | Inv.KH_PRE133 | Inv.H1_G2 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[39632, 39631], models=Inv.H3_PRO | Inv.KH_133),
        ],
    )
...
def _bms_entities() -> Iterable[EntityFactory]:
    ...
    yield from _inner(
        ...
        batvolt=[
            ...
            ModbusAddressesSpec(holding=[37609], models=Inv.KH_133),
        ],
        bat_current=[
            ModbusAddressesSpec(input=[11035], models=Inv.H1_G1 | Inv.KH_PRE119),
            ModbusAddressesSpec(holding=[31035], models=Inv.H3_SET),
            ModbusAddressesSpec(holding=[37610], models=Inv.KH_133),
        ],
        battery_soc=[
            ModbusAddressesSpec(input=[11036], models=Inv.H1_G1 | Inv.KH_PRE119),
            ModbusAddressesSpec(holding=[31024], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[31038], models=Inv.H3_SET),
            ModbusAddressesSpec(holding=[37612], models=Inv.KH_133),
        ],
        battery_temp=[
            ModbusAddressesSpec(input=[11038], models=Inv.H1_G1 | Inv.KH_PRE119),
            ModbusAddressesSpec(holding=[31023], models=Inv.H1_G1 | Inv.H1_LAN | Inv.H1_G2 | Inv.KH_PRE133),
            ModbusAddressesSpec(holding=[31037], models=Inv.H3_SET),
            ModbusAddressesSpec(holding=[37611], models=Inv.KH_133),
        ],
        bms_cell_temp_high=[
            ModbusAddressesSpec(input=[11043], models=Inv.H1_G1 | Inv.KH_PRE119),
            ModbusAddressesSpec(holding=[37617], models=Inv.KH_133),
        ],
        bms_cell_temp_low=[
            ModbusAddressesSpec(input=[11044], models=Inv.H1_G1 | Inv.KH_PRE119),
            ModbusAddressesSpec(holding=[37618], models=Inv.KH_133),
        ],
        bms_cell_mv_high=[
            ModbusAddressesSpec(input=[11045], models=Inv.H1_G1 | Inv.KH_PRE119),
            ModbusAddressesSpec(holding=[37619], models=Inv.KH_133),
        ],
        bms_cell_mv_low=[
        ...
        bms_kwh_remaining=[
            ...
            ModbusAddressesSpec(holding=[37632], models=Inv.KH_133),
        ],
    )
    yield from _inner(
        index=1,
...
def _configuration_entities() -> Iterable[EntityFactory]:
    yield ModbusWorkModeSelectDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=41000, models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
        ],
        name="Work Mode",
    ...
    yield ModbusWorkModeSelectDescription(
        key="work_mode",
        address=[
            ModbusAddressSpec(holding=49203, models=Inv.KH_133),
        ],
        name="Work Mode",
        options_map={
            1: "Self Use",
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41007], models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[46607], models=Inv.H3_PRO | Inv.KH_133),
        ],
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=41007, models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressSpec(holding=46607, models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Max Charge Current",
        mode=NumberMode.BOX,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41008], models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[46608], models=Inv.H3_PRO | Inv.KH_133),
        ],
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=41008, models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressSpec(holding=46608, models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Max Discharge Current",
        mode=NumberMode.BOX,
        device_class=NumberDeviceClass.CURRENT,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41009], models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[46609], models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Min SoC",
        device_class=SensorDeviceClass.BATTERY,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=41009, models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressSpec(holding=46609, models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Min SoC",
        mode=NumberMode.BOX,
        native_min_value=10,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41010], models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[46610], models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Max SoC",
        device_class=SensorDeviceClass.BATTERY,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=41010, models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressSpec(holding=46610, models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Max SoC",
        mode=NumberMode.BOX,
        native_min_value=10,
    ...
    yield ModbusSensorDescription(
        ...
        addresses=[
            ...
            ModbusAddressesSpec(holding=[41011], models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressesSpec(holding=[46611], models=Inv.H3_PRO | Inv.KH_133),
        ],
    ...
    yield ModbusNumberDescription(
        ...
        address=[
            ...
            ModbusAddressSpec(holding=41011, models=Inv.H1_G1 | Inv.H1_G2 | Inv.KH_PRE133 | Inv.H3_SET),
            ModbusAddressSpec(holding=46611, models=Inv.H3_PRO | Inv.KH_133),
        ],
        name="Min SoC (On Grid)",
        mode=NumberMode.BOX,
        native_min_value=10,
